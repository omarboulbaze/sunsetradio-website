...
<meta name="description" content="Sunset Radio est une radio communautaire française" />
 ...
 <!-- NAV BAR -->
 <nav class="navbar navbar-expand-lg barreNavSRcity big navbar-dark bg-dark">
 ...
 <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <li class="nav-item pl-5">
       <a class="nav-link colorSRcity active" id="page-home">Accueil <span class="sr-only">(current)</span></a>
     </li>
...
<div class="row d-flex justify-content-around ">
   ...
   <div class="col-5 " onclick=" $('.container').load('poles.php .container');">
   <div class="top-page pointer">
   <h1 class="top-text">Pôles</h1>
  <img src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/4d8ccfa9-0c40-488c-8689-f397b4fbdb19/dd6pct3-b6e2aefc-2b14-4151-890b-82cf7c62e8bc.png/v1/fill/w_900,h_888,q_70,strp/habbo_avengers_endgame_characters_by_que_miras93_dd6pct3-pre.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..Wjll5q3oE3FPA-X1GUu_ymBMo0N3Ajm9nGvDqfZqjfQ" class="rounded top-img status">
   </div>
   </div>

  
 
   <div class="col-5" onclick=" $('.container').load('orga.php .container');">
   <div class="top-page pointer" >
   <h1 class="top-text">Organisations</h1>
  <img src="https://pbs.twimg.com/media/EfoZlQ9X0Aww3k6.png" class="rounded top-img status">
   </div>
   </div>
