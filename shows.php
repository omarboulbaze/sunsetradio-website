...
<!-- OG META -->
<meta property="og:site_name" content="www.sunsetradio.me/shows">
<meta property="og:url" content="https://www.sunsetradio.me/shows">
<meta property="og:title" content="Les émissions de Sunset Radio">
...
<!-- TITLE -->
<title>Sunset Radio - Émissions</title>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item pl-5">
      ...
      <li class="nav-item">
        <a class="nav-link pl-5 colorSR active" href="shows.php">Émissions</a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link pl-5 colorSR" href="bot.php" >Commandes BOT</a>
      </li>
...
<h1 class="text-center main">Nos émissions</h1>
<h3 class="text-center subtext">Préparées et animées avec <i class="fas fa-heart heart"></i></h3>
...
<div class="card mx-3" style="width: 1000px">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="./image/sunsetparty.jpg" class="card-img resize" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
...
<h3 class="card-text">Présenté par <b>EMIL</b></h3>
        ...
        <p class="card-text">Découvrez les derniers MIX de notre animateur EMIL en direct sur Sunset Radio !</p>
        <br>
      </div>
    </div>
  </div>
...
<div class="card mx-3" style="width: 1000px">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="./image/latino.jpg" class="card-img resize" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h1 class="card-title">Hits Latino</h1>
        <h3 class="card-text"><span class="badge badge-pill badge-danger">MUSIQUE</span></h3>
        <h5 class="card-text">Durée : <span class="badge badge-pill badge-info">60 min</span> </h5>
<br>
<h3 class="card-text">Présenté par <b>Maïa</b></h3>

        <p class="card-text">C'est juste Maïa qui joue Despacito en boucle jusqu'à perdre la moitié de nos auditeurs.</p>
        <br>
      </div>
    </div>
  </div>
